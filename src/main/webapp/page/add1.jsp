  ...
  <div class="body-content">
    <form method="post" class="form-x" action="">
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" value="" name="title" data-validate="required:请输入房间号" />
          <div class="tips"></div>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" value="" name="title" data-validate="required:请输入单位为㎡" /><span id="uint"></span>
          <div class="tips"></div>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="field" style="padding-top:8px;">
          首页 <input id=""  type="checkbox" />
          推荐 <input id=""  type="checkbox" />
          置顶 <input id=""  type="checkbox" />
        </div>
      </div>
